  ...
  return (
    <div className='bg-cover bg-[url("/hero-bg.png")] rounded-4xl px-3.5 py-10 lg:py-16 flex flex-col gap-4'>
        ...
        <div className='mt-2.5 h-fit flex flex-col lg:flex-row gap-7 justify-between'>
            <div className='bg-cover bg-[url("/service-img-1.png")] h-96 w-full lg:w-[30%] rounded-4xl flex justify-center items-end pb-7'>
                <p className='text-xl font-semibold text-white'>Debt Consolidation</p>
            </div>

            <div className='bg-cover bg-[url("/service-img-2.png")] h-96 w-full lg:w-[30%] rounded-4xl flex justify-center items-end pb-7'>
                <p className='text-xl font-semibold text-white'>Personal Loans</p>
            </div>

            <div className='bg-cover bg-[url("/service-img-3.png")] h-96 w-full lg:w-[30%] rounded-4xl flex justify-center items-end pb-7'>
                <p className='text-xl font-semibold text-white'>Business Loans</p>
            </div>
        </div>
